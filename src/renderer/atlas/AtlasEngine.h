...
#pragma warning(suppress : 4324) // 'CustomConstBuffer': structure was padded due to alignment specifier
        ...
        struct Resources
        {
            ...
            i32x2 dwriteRenderTargetSize{ 128, 64 };
            i32x2 dwriteRenderTargetOrigin;
            f32x2 dwriteRenderTargetOriginDIP;
            wil::com_ptr<IDWriteBitmapRenderTarget1> dwriteRenderTarget;
